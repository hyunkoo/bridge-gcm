    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<ResponseBody> call = restApiService.login(user_id.getText().toString().trim(), password.getText().toString().trim());
                            ...
                            try {
                                ...
                                if(object.has("error")) {
                                    if(object.getString("code").equals("2")) {
                                        Toast.makeText(MainActivity2.this, object.getString("error"), Toast.LENGTH_SHORT).show();
                                    }
                                }else {
                                    ...
                                    Toast.makeText(MainActivity2.this, "로그인하였습니다", Toast.LENGTH_SHORT).show();
                                }
                            }catch(Exception e) {
                                e.printStackTrace();
                            }
